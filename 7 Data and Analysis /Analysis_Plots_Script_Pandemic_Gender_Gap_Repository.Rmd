...
my.orchard(m, mod="1", alpha=0.5,data = all_data, whisker=0.025
           , group = "Article.ID", xlab = "Effect size")+
...
f1<-funnel(meta_measured, level=c(90, 95, 99), shade=c("white", "gray", "darkgray"),
       yaxis="seinv",xlab="Effect size",ylab="Precision (1/SE)",digits=c(1,0),xlim=c(-1.5,1.5),ylim=c(1,180), legend=TRUE,back="white", hlines = "white", main="a) Survey response") 
